...
const getAllSastojci = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        ...
        const result = (yield pool.request().input('searchParam', mssql_1.default.NVarChar, search).query(query)).recordsets[0];
...
exports.default = getAllSastojci;

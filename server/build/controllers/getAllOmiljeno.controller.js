...
const getAllOmiljeno = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const rawData = (yield pool.request()
            ...
            .query('select * from Func_Omiljeni_Recepti(@id_korisnik)'))
            .recordsets[0];
...
exports.default = getAllOmiljeno;

...
const insertRecept = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        ...
        const insertedReceptID = (yield pool.request()
            .input('id_korisnik', mssql_1.default.Int, Number(decodedUser.id))
            .input('datum_kreiranja', mssql_1.default.DateTime2, receptData.datum_kreiranja)
            .input('naslov', mssql_1.default.NVarChar, receptData.naslov)
            .input('porcija', mssql_1.default.NVarChar, receptData.porcija)

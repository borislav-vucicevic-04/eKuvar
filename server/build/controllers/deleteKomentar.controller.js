...
const deleteKomentar = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    `;
        ...
        yield pool.request()
            .input('id_komentar', mssql_1.default.Int, Number(id_komentar))
            .query(query);
...
exports.default = deleteKomentar;
